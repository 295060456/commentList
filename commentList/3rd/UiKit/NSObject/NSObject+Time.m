...
///格式化时间戳转字符串
+(NSString *)timeStampConversionNSString:(NSString *)timeStamp ByFormat:(NSString *)format{
    NSDateFormatter *formatter = [[NSDateFormatter alloc]init];
...
//    dateString = [dateString substringToIndex:16];//误区** 字符串长度必须与formatter长度对应一致 不然date就是nil
